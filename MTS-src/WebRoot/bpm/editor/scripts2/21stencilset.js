...
ORYX.Core.StencilSet.StencilSet = Clazz.extend({
  ...
  construct:function(source){
    ...
    if(ORYX.CONFIG.BACKEND_SWITCH){
      ...
      jQuery.ajax({
        url:'../service/editor/stencilset',
        async:false,
        //        success:this._init.bind(this),
        //        error:this._cancelInit.bind(this)
        success:this._init.bind(this),
        error:this._cancelInit.bind(this)
      });
  ...
  addExtension:function(url){
    jQuery.ajax({
      ...
      success:(function(transport){
        this.addExtensionDirectly(transport);
      }).bind(this),
...
//    });
  ...
  _init:function(response){
    ...
    if(this._jsonObject.propertyPackages){
      jQuery.each($A(this._jsonObject.propertyPackages),(function(pp){
...
//      }).bind(this));
    ...
    // init each stencil
    var $this = this;
    jQuery.each($A(this._jsonObject.stencils),(function(i,stencil){
      defaultPosition++;
