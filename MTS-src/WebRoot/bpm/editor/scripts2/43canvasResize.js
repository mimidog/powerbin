...
//			buttonGrow.show();
        jQuery(buttonGrow).show();
			...
			if(position=="N" && (y1>ORYX.CONFIG.CANVAS_RESIZE_INTERVAL || (isEmpty && h>ORYX.CONFIG.CANVAS_RESIZE_INTERVAL))) jQuery(buttonShrink).show();
			else if(position=="E" && (w-x2)>ORYX.CONFIG.CANVAS_RESIZE_INTERVAL) jQuery(buttonShrink).show();
			else if(position=="S" && (h-y2)>ORYX.CONFIG.CANVAS_RESIZE_INTERVAL) jQuery(buttonShrink).show();
			else if(position=="W" && (x1>ORYX.CONFIG.CANVAS_RESIZE_INTERVAL || (isEmpty && w>ORYX.CONFIG.CANVAS_RESIZE_INTERVAL))) jQuery(buttonShrink).show();
			else jQuery(buttonShrink).hide();
		}).bind(this);
        
		var hideButtons = function() {
//			buttonGrow.hide();
//			buttonShrink.hide();
      jQuery(buttonGrow).hide();
      jQuery(buttonShrink).hide();
		};
