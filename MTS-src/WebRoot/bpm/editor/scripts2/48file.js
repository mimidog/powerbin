...
//          var resJSON = transport.responseText.evalJSON();
  ...
  retrieveModelData:function(success){
    ...
    jQuery.ajax({
      url:"../service/model/" + modelMeta.modelId + "/json",
      async:true,
