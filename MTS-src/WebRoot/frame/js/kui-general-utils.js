...
;(function($){
	...
	var general = {
		...
		singleTable:"<table id=\"#table_id#\" class=\"kui-datagrid\" kui-options=\"#queryParams#\" style=\"\" title=\" \"></table>",
		coupleTables:["<div class=\"kui-layout\" kui-options=\"fit:true\">",
		             "<div id=\"#west_table_id#_panel\" kui-options=\"region:'west'\" title=\" \" style=\"width:"+(cw/2)+"px;\">",
		             "<table id=\"#west_table_id#\" class=\"kui-datagrid\" kui-options=\"#queryParams#\" style=\"height:"+(ch-39)+"px;\"></table>",
		             "</div>",
		             "<div id=\"#center_table_id#_panel\" kui-options=\"region:'center',title:' ',split:true,iconCls:'icon-ok'\" style=\"\">",
		             "<table id=\"#center_table_id#\" class=\"kui-datagrid\" kui-options=\"#queryParams#\" style=\"height:"+(ch-39)+"px;\"></table>",
		             "</div>",
		             "</div>"
		             ],
		verticalLayout:["<div id=\"#west_table_id#_panel\" class=\"kui-panel\" kui-options=\"resizable:true\" style=\"height:270px;\">",
			...
			if(param != null){
				...
				if (paramArray != null) {
			    	for(var i = 0; i < paramArray.length; i++){
			    		...
			    		if(rArray.length>1&&rArray[0] != "_"&&rArray[0] != "TAB_CODE"){
			    			var reg = new RegExp("\\$\\{.+\\}");
