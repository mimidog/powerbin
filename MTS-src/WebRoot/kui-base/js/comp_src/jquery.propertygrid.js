...
(function($) {
    ...
    $.fn.propertygrid = function(options, param) {
        ...
        return this.each(function() {
            ...
            if (state) {
                ...
                var opts = $.extend({},
                $.fn.propertygrid.defaults, $.fn.propertygrid.parseOptions(this), options);
    ...
    $.fn.propertygrid.parseOptions = function(target) {
        var t = $(target);
        return $.extend({},
        $.fn.datagrid.parseOptions(target), $.parser.parseOptions(target, [{
            showGroup: 'boolean'
        }]));
    };

    // the group view definition
    var groupview = $.extend({},
    ...
    function stopEditing(target) {
		...
		/*else {
            //t.datagrid('cancelEdit', index); //ray kui datagrid нч cancelEdit
        }*/
		opts.editIndex = index;
    }
})(jQuery);