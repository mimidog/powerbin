...
//			this.node.removeClassName('Oryx_hover');
    if(jQuery(this.node).hasClass('Oryx_down'))
      jQuery(this.node).removeClass('Oryx_down');

    if(jQuery(this.node).hasClass('Oryx_hover'))
      jQuery(this.node).removeClass('Oryx_hover');
	},

	activate: function(evt) {
		jQuery(this.node).addClass('Oryx_down');
		//Event.stop(evt);
		this.dragStart = true;
	},
...
//		return this.node.hasClassName('Oryx_hover') ? true: false;
    return jQuery(this.node).hasClass('Oryx_hover') ? true: false;
	},
...
//		this.node.addClassName('Oryx_hover');
    jQuery(this.node).addClass('Oryx_hover');
		this.dragStart = false;
