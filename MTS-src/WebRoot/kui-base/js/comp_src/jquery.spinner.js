...
(function($) {
        ...
        return this.each(function() {
            ...
            if (state) {
                ...
                state = $.data(this, 'spinner', {
                    options: $.extend({},
                    $.fn.spinner.defaults, $.fn.spinner.parseOptions(this), options),
                    spinner: init(this)
                });
    ...
    $.fn.validatebox.defaults, {
        ...
        spin: function(down) {},
        // the function to implement the spin button click
        onSpinUp: function() {},
        onSpinDown: function() {}
    });
    /**
    ...
    function init(target) {
        var spinner = $('<span class="spinner">' + '<span class="spinner-arrow">' + '<span class="spinner-arrow-up"></span>' + '<span class="spinner-arrow-down"></span>' + '</span>' + '</span>').insertAfter(target);
    ...
    function setSize(target, width) {
        ...
        var arrowWidth = spinner.find('.spinner-arrow').outerWidth() || 18;
    ...
    function bindEvents(target) {
        ...
        if (!opts.disabled) {
            spinner.find('.spinner-arrow-up').bind('mouseenter.spinner',
            function() {
    ...
    function setDisabled(target, disabled) {
        ...
        if (disabled) {
            opts.disabled = true;
            $(target).validatebox("disabled");
        } else {
            opts.disabled = false;
            $(target).validatebox("enabled");
        }
    }
})(jQuery);