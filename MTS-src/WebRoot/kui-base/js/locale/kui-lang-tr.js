...
if ($.fn.reportgrid){
    $.fn.reportgrid.defaults.loadingMessage = "Yükleniyor...";
    $.fn.reportgrid.defaults.loadMsg = 'İşleminiz Yapılıyor, lütfen bekleyin ...';
}
if ($.fn.treegrid && $.fn.datagrid){
    $.fn.treegrid.defaults.loadMsg = $.fn.datagrid.defaults.loadMsg;
}
if ($.message){
    $.message.defaults.ok = 'Tamam';
    $.message.defaults.cancel = 'İptal';
}
if ($.fn.validatebox){
