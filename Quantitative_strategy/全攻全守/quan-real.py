...
def loadConfig():
    ...
    para['FUT_BROKER'] = cf.get("account", "fut_broker")
    para['FUT_USER'] = cf.get("account", "fut_user")
    para['FUT_PWD'] = cf.get("account", "fut_pwd")
...
if __name__ == '__main__':
    ...
    # 登录连接信易快期账户
    api = TqApi(TqAccount(para['FUT_BROKER'], para['FUT_USER'], para["FUT_PWD"]), auth=TqAuth(para['ACCT_ID'], para['ACCT_PWD']))
